...
import {
  ...
  CopyButton,
  CodeblockShiki,
} from "@/packages/ui/code-block";
import type { Languages as ShikiLanguage } from "@/packages/ui/code-block";
import { MARKDOWN_INLINE_CODE_CLASSNAME } from "@/packages/ui/inline-code-style";
        ...
        const hasBlockChild = React.Children.toArray(children).some(
          (child) => {
            ...
            if (typeof childType === 'function') {
              const component = childType as React.ComponentType & {
                displayName?: string;
              };
